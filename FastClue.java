...
public final class FastClue {
  ...
  private static String chum(Object noun) throws ExitException {
      // more or less just needs to be ported
      // noun here is either a cell or a cord
      // if it's a cell it's some weird backwards compat thing, just do what it says
  ...
  private static Object skipHints(Object formula) throws ExitException {
	...
	private static Axis parseToParent(Object noun) throws ExitException {
      //noun is either [0 something] (axis to parent)
      // or [1 0], no parent
      // have to skip hints cause it's a nock formula so who the fuck knows what it is
  ...
  private static Map<String,Hook> parseHooks(Object noun) throws ExitException {
      // annoying.
      //noun is list of key value pairs
      // keys are terms
      // values are nock formulas
      //   three kinds of hooks for jets
      //   fragment hooks -> look in subject
      //   kick/arm hooks -> kick arm out of some core in subject
      //     whole core [0 1]
      //     core somewhere else [0 something]
